      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              Text(
                  "العمر المناسب: ${ageRange.start.round()} - ${ageRange.end.round()}"),
              RangeSlider(
                values: ageRange,
                min: 18,
                max: 60,
              ...
              DropdownButtonFormField<String>(
                ...
                decoration: const InputDecoration(labelText: "النوع المفضل"),
              ),
              TextFormField(
                decoration: const InputDecoration(labelText: "المهنة المطلوبة"),
