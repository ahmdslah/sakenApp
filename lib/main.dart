...
import 'package:saken_mobile/core/api/dio_consumer.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => ResetCubit(DioConsumer(dio: Dio())),
        ),
        BlocProvider(
      ...
      child: GetMaterialApp(
          ...
          routes: {
            ...
            Routes.welcome1: (context) => const Welcome1(),
            Routes.welcome2: (context) => const Welcome2(),
            Routes.welcome3: (context) => const Welcome3(),
