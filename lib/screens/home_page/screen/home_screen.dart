...
class _HomeScreenState extends State<HomeScreen> {
  int selectedindex=0;
  List<Widget>tabs=[HomeTab(),RecommendationTab(),FavTab(),MessagesTab(),ProfileTab()];
  void initState(){
    super.initState();
  }
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(currentIndex: selectedindex
          ,onTap: (newindex){selectedindex=newindex;
        setState(() {
          ...
          ,items:[BottomNavigationBarItem(icon: SvgPicture.asset("assets/images/home.svg"),
          activeIcon: SvgPicture.asset("assets/images/homes.svg"),
            label: "الرئيسيه"
          ),
            BottomNavigationBarItem(icon: SvgPicture.asset("assets/images/rec.svg"),
                activeIcon: SvgPicture.asset("assets/images/recs.svg"),
                label: "الترشيحات"
            ),
            BottomNavigationBarItem(icon: SvgPicture.asset("assets/images/fav.svg"),
                activeIcon: SvgPicture.asset("assets/images/favs.svg"),
                label: "التفضيلات"
            ),
            BottomNavigationBarItem(icon: SvgPicture.asset("assets/images/message.svg"),
                activeIcon: SvgPicture.asset("assets/images/messages.svg"),
                label: "الرسائل"
            ),
            BottomNavigationBarItem(icon: SvgPicture.asset("assets/images/profile.svg"),
