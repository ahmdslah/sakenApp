      ...
      child: Padding(
        ...
        child: Column(children: [
          Padding(
            ...
            child: Row(children: [
              Expanded(child: CustomFormField(height:height*0.5 , width: width*0.7, hintText: "بحث", controller: searchcontroller, validator:(val){return null;} ,search: true,)),
              IconButton(onPressed: (){}, icon:Icon(Icons.filter_alt_outlined,color: Colors.grey,))
            ],),
          ...
          TabBar(onTap: (index){
            ...
            , tabs: [
              ...
              Tab(child: Container(padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                ...
                child: Text("مؤجرين ",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16,color: selected==1?Colors.white:Colors.black),),
              ),),
              Tab(child: Container(padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(46),
                    color: selected==2?Colors.blueAccent:Color(0xffF5F5F5)
                ),
                child: Text("مستاجرين ",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16,color: selected==2?Colors.white:Colors.black),),
              ),)
            ]
            ,),
          Expanded(
